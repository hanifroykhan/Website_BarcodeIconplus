            ...
            <div class="card">
              ...
              <div class="card-header border-0">
                <h3 class="mb-0">Coverage Area</h3>
                  ...
                  @endif
                  <!-- <form action="/importodp" method="post" enctype="multipart/form-data">
                    @csrf
                    <table align="center">
                      <tr>
                        <td class="col-md-12">
                          <input type="file" name="inputMap" id="inputMap" class="form-control-file m-1 " >
                        </td>
                        <td>
                          <button type="submit" class="btn btn-primary btn-md mr-3">Import</button>
                        </td>
                      </tr>
                    </table>
                  </form> -->
                  ...
                  <br>
                  <h6 class="card-text" >Area : <p id="hasil"></p> </h6> 
                  <h6 class="card-text" >ID FAT : <p id="nama_odp"></p> </h6> 
                  <h6 class="card-text">Port Terpakai : <p id="port"></p></h6>      
                  <h6 class="card-text">Port Idle : <p id="idle"></p></h6>     
                  <h6 class="card-text" >Titik Koordinat : <p id="titik_koordinat"></p> </h6>
                  <h6 class="card-text">Nama OLT : <p id="nama_olt"></p></h6>      
                  <!-- <h5 class="card-text">Status : <p id="status"></p></h5>      -->
                  </div>
                    </div>
...
var data = [
  <?php foreach($koordinatmaps as $key => $value){?>
    {"Tikor":[<?= $value->Tikor_ODP?>],"Nama":"<?=$value->NAMA_ODP?>"},
